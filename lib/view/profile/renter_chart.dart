// lib/view/profile/Renter_chart.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:fl_chart/fl_chart.dart';
import '../../view_model/renterchart_viewmodel.dart';

class RenterChartScreen extends StatelessWidget {
  const RenterChartScreen({super.key});
...
Color _monthColor(int index) {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text("Renter Activity Insight")),
        body: Consumer<ChartViewModel>(
          builder: (context, vm, _) {
            ...
            if (vm.chartData.isEmpty) {
              return const Center(child: Text("No spendings data available."));
            }
            ...
            return Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Total Spent: RM${vm.totalEarned.toStringAsFixed(2)}",
